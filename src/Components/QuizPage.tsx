...
const QuizPage = () => {
  ...
  return (
    <div className="m-auto h-3/4 lg:h-2/3 lg:w-1/2 lg:border border-white text-white p-1 lg:p-20 flex flex-col justify-between ">
      ...
      <div id="timer" className="flex flex-col items-center w-full gap-5">
